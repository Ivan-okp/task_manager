...
from tests.test_cases.test_cases_for_task_service_router import test_cases_service_task_router_for_get_task, \
    test_cases_service_task_router_for_get_specific_task, test_cases_service_task_router_for_create_task, \
    test_cases_service_task_router_for_update_task, test_cases_service_task_router_for_delete_task
...
async def test_delete_task(
    ...
    if expected_status_code == 200:
        ...
        assert response_data["message"] == expected_result["message"]
    ...
    if expected_status_code == 200:
        ...
        assert "message" in response_data
        assert response_data["message"] == expected_result_2["message"]
